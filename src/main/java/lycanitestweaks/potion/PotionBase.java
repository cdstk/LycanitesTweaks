...
public abstract class PotionBase extends Potion {
    ...
    public PotionBase(String name, boolean isBadEffect, int liquidColor) {
        ...
        this.texture = new ResourceLocation(LycanitesTweaks.MODID, "textures/effects/" + name + ".png");
        this.setRegistryName(LycanitesTweaks.MODID, name);
        this.setPotionName("effects." + LycanitesTweaks.MODID + "." + name);
    }
