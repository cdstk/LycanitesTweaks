...
public class Helpers {
    ...
    public static HashMap<String, ArrayList<String>> getChargeElementsMap(){
        if(Helpers.chargeElementsMap == null){
            ...
            if(ForgeConfigHandler.debug.debugLoggerAutomatic) LycanitesTweaks.LOGGER.log(Level.DEBUG, "chargeElementsMap: {}", Helpers.chargeElementsMap);
        }
    ...
    public static HashMap<String, ArrayList<String>> getCreatureElementsMap(){
        if(Helpers.creatureElementsMap == null){
            ...
            if(ForgeConfigHandler.debug.debugLoggerAutomatic) LycanitesTweaks.LOGGER.log(Level.DEBUG, "creatureElementsMap: {}", Helpers.creatureElementsMap);
        }
